...
<Tip>
  For multi-room scenarios, check out [WebSocket Rooms](/realtime/websocket-rooms) — it provides room management, broadcasting, and presence tracking out of the box.
</Tip>
