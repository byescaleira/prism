...
<Tip>
  For real-time push to browsers, consider [Server-Sent Events](/realtime/sse) instead of raw chunked streaming — SSE has built-in reconnection and event naming that browsers handle automatically.
</Tip>
