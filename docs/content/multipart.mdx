...
<Tip>
  For structured file upload handling with size limits and type validation, see [File Uploads](/content/file-upload) — it builds on top of multipart parsing with `PrismUploadProcessor`.
</Tip>
