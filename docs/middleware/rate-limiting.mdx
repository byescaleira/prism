...
<Note>
For more advanced rate limiting with sliding windows, per-user limits, and `X-RateLimit` headers, see [Advanced Rate Limiting](/middleware/rate-limiting-v2).
</Note>

<CardGroup cols={1}>
  <Card title="Advanced Rate Limiting" icon="gauge" href="/middleware/rate-limiting-v2">
