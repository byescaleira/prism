...
<CardGroup cols={2}>
  <Card title="Add Authentication" icon="lock" href="/middleware/auth">
    Protect endpoints with bearer token authentication and session cookies.
  </Card>
  <Card title="Add WebSockets" icon="signal-stream" href="/realtime/websocket">
    Build real-time features like live notifications when bookmarks are added.
  </Card>
  <Card title="Add a GraphQL API" icon="diagram-project" href="/graphql/schema">
