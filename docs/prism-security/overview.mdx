...
<CardGroup cols={2}>
  <Card title="Permissions & Biometrics" icon="fingerprint" href="/docs/prism-security/permissions-biometrics">
    Request permissions and authenticate with Face ID.
  </Card>
  <Card title="Encryption & Keychain" icon="lock" href="/docs/prism-security/encryption-keychain">
    Encrypt data and store secrets in the keychain.
  </Card>
  <Card title="Cert Pinning & Integrity" icon="certificate" href="/docs/prism-security/cert-pinning-integrity">
    Pin certificates and detect tampering.
  </Card>
  <Card title="Secure Transport" icon="satellite-dish" href="/docs/prism-security/secure-transport">
    Encrypted channels with ECDH and forward secrecy.
  </Card>
  <Card title="Audit, Tokens & Privacy" icon="eye-slash" href="/docs/prism-security/audit-token-privacy">
