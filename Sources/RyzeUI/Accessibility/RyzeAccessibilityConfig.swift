...
/// )
/// ```
public struct RyzeAccessibilityConfig {
    private var label: LocalizedStringKey = ""
    private var hint: LocalizedStringKey = ""
    private var testID: String = ""
    private var traits: AccessibilityTraits = []
    private var actions: [RyzeAccessibilityAction] = []
    ...
    @discardableResult
    public func action(_ action: RyzeAccessibilityAction) -> Self {
        var copy = self
    ...
    @discardableResult
    public func actions(_ actions: [RyzeAccessibilityAction]) -> Self {
        var copy = self
    ...
    public func build() -> RyzeAccessibilityProperties {
...
@resultBuilder
public enum RyzeAccessibilityBuilder {
    public static func buildBlock(_ components: RyzeAccessibilityProperties...) -> [RyzeAccessibilityProperties] {
        components
    }

    public static func buildOptional(_ component: RyzeAccessibilityProperties?) -> RyzeAccessibilityProperties? {
        component
    }

    public static func buildEither(first component: RyzeAccessibilityProperties) -> RyzeAccessibilityProperties {
        component
    }

    public static func buildEither(second component: RyzeAccessibilityProperties) -> RyzeAccessibilityProperties {
        component
    }

    public static func buildArray(_ components: [RyzeAccessibilityProperties]) -> [RyzeAccessibilityProperties] {
        components
    }
}
