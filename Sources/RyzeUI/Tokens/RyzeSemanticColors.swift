...
// MARK: - RyzeSemanticColors

public struct RyzeSemanticColors: Sendable {
    // MARK: - State Colors
    ...
    public static var dark: RyzeSemanticColors {
        RyzeSemanticColors(
    ...
    public static var highContrast: RyzeSemanticColors {
        RyzeSemanticColors(
            active: .yellow,
            inactive: .gray,
...
// MARK: - RyzeColorProtocol Extension

extension RyzeColorProtocol {
    public var semanticDark: RyzeSemanticColors {
        .dark
    }

    public var semanticHighContrast: RyzeSemanticColors {
        .highContrast
    }
}
